...
public class AutoEncoderDriveStraight extends CommandBase {
  ...
  public AutoEncoderDriveStraight(DriveSubsystem s_DriveSubsystem, double distance, double speed, double rightOffset) {
  ...
  @Override
  public void execute() {
    DriveSubsystem.differentialTankDrive(v_autoSpeed, v_autoSpeed+v_rightOffSet);
