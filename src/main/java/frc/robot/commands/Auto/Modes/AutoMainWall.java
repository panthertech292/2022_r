...
public class AutoMainWall extends SequentialCommandGroup {
  ...
  public AutoMainWall(DriveSubsystem s_DriveSubsystem, PickupSubsystem s_PickupSubsystem, ShooterSubsystem s_ShooterSubsystem, BeltSubsystem s_BeltSubsystem) {
    ...
    addCommands(
    new AutoEncoderDriveForBack(s_DriveSubsystem, 48, .4) //Drive to shooting position
    //new RunShooterBelt(s_ShooterSubsystem, s_BeltSubsystem, 0.27, 0.27, 1550, BeltConstants.kFrontBeltSpeed, BeltConstants.kBackBeltSpeed).withTimeout(3), //Run the shooter
