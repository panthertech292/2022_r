...
//AutoTurn2 is dead! Long live EncoderTurn! (Please work, please)
...
public class EncoderTurn extends CommandBase {
  ...
  /** Creates a new EncoderTurn. */
  public EncoderTurn(DriveSubsystem s_DriveSubsystem, double speed, double degrees) {
