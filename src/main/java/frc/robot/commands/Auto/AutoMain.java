...
public class AutoMain extends SequentialCommandGroup {
  ...
  public AutoMain(DriveSubsystem s_DriveSubsystem, PickupSubsystem s_PickupSubsystem, ShooterSubsystem s_ShooterSubsystem) {
    ...
    new PickupArmDown(s_PickupSubsystem), //Need a way for this to actually end, maybe use the .withTimeout stuff mark was talking about, or pass in something that can be used as an end condition in a new command.
